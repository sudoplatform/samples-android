...
class App : Application(), CoroutineScope {
    ...
    lateinit var adTrackerBlockerClient: SudoAdTrackerBlockerClient

    override fun onCreate() {
        super.onCreate()

        logger = Logger("adTrackerBlockerSample", AndroidUtilsLogDriver(LogLevel.VERBOSE))

        // Create an instance of SudoUserClient to perform registration and sign in.
        sudoUserClient = SudoUserClient.builder(this)
            .setNamespace("atb-test")
            .setLogger(logger)
            .build()
        ...
        // Create an instance of SudoAdTrackerBlockerClient to perform Ad Tracker Blocker interactions
