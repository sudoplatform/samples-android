...
import com.sudoplatform.direlayexample.sudos.SudoViewHolder
...
class SudosRobot : BaseRobot() {
    ...
    fun checkSudosItemsDisplayed() {
        waitForViewToDisplay(toolbarInfoButton, 60_000L)
        waitForViewToDisplay(createSudoButton, 10_000L)
    }
    ...
    fun navigateToPostboxesScreen(position: Int) {
