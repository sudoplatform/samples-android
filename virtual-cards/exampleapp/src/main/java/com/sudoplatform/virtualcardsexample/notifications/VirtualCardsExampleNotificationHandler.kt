...
package com.sudoplatform.virtualcardsexample.notifications
...
import com.sudoplatform.sudovirtualcards.initVirtualCardsNotifications
 ...
 */
class VirtualCardsExampleNotificationHandler :
    FirebaseMessagingService(),
    CoroutineScope,
    SudoVirtualCardsNotificationHandler {
            ...
            Dispatchers.IO +
                CoroutineExceptionHandler { _, throwable ->
                    if (throwable !is CancellationException) {
                        app.logger.error("Error in VirtualCardsExampleNotificationHandler coroutine")
                    }
                }
    ...
    /** Subscribe to notifications from the virtual cards service. */
    ...
    /** Unsubscribe from notifications from the virtual cards service. */
    ...
    /** Process notifications from the virtual cards service when funding sources are updated. */
    override fun onMessageReceived(message: RemoteMessage) {
        app.sudoNotificationClient.process(message)
    }

    /** Emit a notification when a funding source is updated. */
    override fun onFundingSourceChanged(notification: VirtualCardsFundingSourceChangedNotification) {
        ...
        val channelId = "fundingSourceUpdated"
        ...
        val notificationBuilder =
            NotificationCompat
                ...
                .setContentTitle("Funding source requires attention")
                .setContentText("Your ${notification.type} funding source ending in ${notification.last4} requires attention")
